...
class SessionManager:
    ...
    async def get_user_language(self, phone: str) -> str:
        ...
        result = await self._client.table("users").select("language").eq("phone", phone).execute()
    ...
    async def set_user_language(self, phone: str, language: str):
        ...
        await self._client.table("users").update({"language": language}).eq("phone", phone).execute()
